...
exports.default = (function (config) { return function (_a) {
    ...
    return __awaiter(_this, void 0, void 0, function () {
        var db, query, document, createdFilter, response;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    document = config.convertItemIntoDocument(__assign({}, item, { id: id }));
                    createdFilter = createIdFilter_1.default({ id: id, filter: filter, config: config });
                    return [4 /*yield*/, Promise.resolve(filterItems_1.default(query, createdFilter).update(document))];
                case 2:
                    response = _c.sent();
                    if (!response) {
