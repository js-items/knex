...
exports.default = (function (config) { return function (_a) {
    ...
    return __awaiter(_this, void 0, void 0, function () {
        var db, query, createdFilter, document, item;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Promise.resolve(filterItems_1.default(query, createdFilter).first())];
                case 2:
                    document = _c.sent();
                    if (!document) {
                        throw new foundation_1.ItemNotFoundError(config.itemName, id);
                    }
                    item = config.convertDocumentIntoItem(document);
